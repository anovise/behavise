...
- **`@behavier/core`** — foundational package
...
- **`@behavier/pointer`** — pointer input tracking
...
- **`@behavier/page`** — page navigation and scroll tracking
...
- **`@behavier/interaction`** — user interaction tracking
...
- **`behavier`** — main entry package
  - Re-exports all `@behavier/*` symbols
  - `createBehavier(options?)` factory — creates a pre-configured `BehavierInstance` with all desired trackers; includes `startAll / stopAll / resetAll` convenience methods

- **`apps/example`** — interactive showcase (Vite + Vanilla TypeScript)
  - Live demonstration of all six trackers in a single-page app
  - Deployable to GitHub Pages at `reasvyn.github.io/showcase/behavier`
...
[Unreleased]: https://github.com/reasvyn/behavier/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/reasvyn/behavier/releases/tag/v0.1.0
